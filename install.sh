#!/usr/bin/env sh
# Universal installer for breachwatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/breachwatch.git"
echo "Installing breachwatch ..."
...
echo "Done. Run: breachwatch --help"
